...
FeaturePlot(emb_int_specific_recluster, features = c('ZC204.12', 'cpr-1', 'ceh-37'), raster=F)
VlnPlot(emb_int_specific_recluster, features = c('ZC204.12', 'cpr-1', 'ceh-37'))

FeaturePlot(emb_int_specific_recluster, features = c('irg-7', 'pal-1', 'cpr-1', 'ceh-37'), raster=F)
VlnPlot(emb_int_specific_recluster, features = c('irg-7', 'pal-1', 'cpr-1', 'ceh-37'))

FeaturePlot(emb_int_specific_recluster, features = c('faah-1', 'pbo-4', 'psa-3'), raster=F)
VlnPlot(emb_int_specific_recluster, features = c('faah-1', 'pbo-4', 'psa-3'))
```
