...
# (Loose filtering) contamination clusters we want to remove = 0, 2, 7, 8, 9, 10, 12, 15, 16, 17 
## (Loose filtering) contamination clusters we want to remove = 0, 2, 3, 6, 7, 8, 15, 16  
emb.GFPpooled_v2.filteredClusters_unint <- subset(emb.GFPpooled_v2, idents = c('0', '2', '3', '6', '7', '8', '15', '16', '17'), invert = TRUE)
#emb.GFPpooled_v2.filteredClusters_unint <- subset(emb.GFPpooled_v2, idents = c('0', '2', '3', '6', '7', '8', '15', '16', '17'), invert = TRUE)

emb.GFPpooled_v2.filteredClusters_unint <- subset(emb.GFPpooled_v2, subset = !(unintegrated_clusters %in% c('0','2','3','6','7','8','15','16')))

emb.GFPpooled_v2.filteredClusters_cca <- subset(emb.GFPpooled_v2, subset = !(cca_clusters %in% c('0','2','3','6','7','8','15','16')))
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_early_dev.pdf", height = 10, width = 20)
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_mid_dev.pdf", height = 10, width = 20)
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_late_dev.pdf", height = 10, width = 20)
...
ant_cen_gene_list <- unique(unlist(ant_cen_clusters.list))
ant_post_gene_list <- unique(unlist(ant_post_clusters.list))
cen_post_gene_list <- unique(unlist(cen_post_clusters.list))
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_anterior.pdf", height = 10, width = 20)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_anterior-cen_post.pdf", height = 10, width = 20)
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_central.pdf", height = 10, width = 20)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_central-ant_post.pdf", height = 10, width = 20)
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_posterior.pdf", height = 10, width = 20)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_posterior-ant_cen.pdf", height = 10, width = 20)
...
dim(emb.GFPpooled_v2.filteredClustersFINAL) #15116   1073
