...
# (Loose filtering) contamination clusters we want to remove = 9, 18, 8, 12
emb.GFPpooled_v2.filteredClusters <- subset(emb.GFPpooled_v2, idents = c('9', '18', '8', '12'), invert = TRUE)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("elt-2", "elt-7", "ges-1"), ncol = 2)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("glh-1", "nos-1", "pgl-1"), ncol = 2)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("myo-3", "pat-10", "lev-11"), ncol = 2)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("rab-3", "odr-2", "mec-7"), ncol = 2)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("myo-2", "tnc-2", "phat-2"), ncol = 2)
...
VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("elt-1", "elt-3", "dpy-7"), ncol = 2)
...
# anterior intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.anterior-int.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("C14C6.5", "cpr-1"), ncol = 2 , coord.fixed = TRUE)
dev.off()

# central intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.central-int.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("clec-56", "endu-2"), ncol = 2 , coord.fixed = TRUE)
dev.off()

# posterior intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.central-int.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("pbo-4"), ncol = 2 , coord.fixed = TRUE)
dev.off()
```
