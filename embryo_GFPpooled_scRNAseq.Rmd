...
DimPlot(emb.GFPpooled.specificClusters.recluster, reduction = "umap", label = "TRUE", label.box = TRUE, label.size = 8, pt.size = 3) + theme(legend.text = element_text(size = 20))
