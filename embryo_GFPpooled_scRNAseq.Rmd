...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.UMAP.pdf", height = 6, width = 12)
...
emb.GFPpooled_v2.finalfiltClusters <- FindNeighbors(emb.GFPpooled_v2.finalfiltClusters, dims = 1:5)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.finalfiltClusters.UMAP-rep.pdf", height = 6, width = 6)
DimPlot(emb.GFPpooled_v2.finalfiltClusters, reduction = "umap", split.by = "rep_group")
dev.off()
