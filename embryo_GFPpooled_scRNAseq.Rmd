...
emb.ALLpooled_v2 <- IntegrateLayers(object = emb.ALLpooled_v2, method = HarmonyIntegration, orig.reduction = "pca", new.reduction = "integrated.harmony", verbose = FALSE)

emb.ALLpooled_v2 <- FindNeighbors(emb.ALLpooled_v2, reduction = "integrated.cca", dims = 1:20)
emb.ALLpooled_v2 <- FindNeighbors(emb.ALLpooled_v2, reduction = "integrated.harmony", dims = 1:20)
...
emb.ALLpooled_v2 <- RunUMAP(emb.ALLpooled_v2, reduction = "integrated.harmony", dims = 1:20, reduction.name = "umap.harmony")


pdf("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.int.cca.pdf", height = 6, width = 9)
DimPlot(emb.ALLpooled_v2, reduction = "umap.cca", group.by = c("rep_group", "cca_clusters"), label.size = 4, pt.size = 1)
dev.off()
...
DimPlot(emb.ALLpooled_v2, reduction = "umap.harmony", group.by = c("rep_group", "harmony_clusters"), label.size = 4, pt.size = 1)
dev.off()

pdf("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.int.harmony.rep.pdf", height = 6, width = 9)
DimPlot(emb.ALLpooled_v2, reduction = "umap.harmony", split.by = "rep_group", label.size = 4, pt.size = 1)
dev.off()
...
emb.GFPpooled_v2 <- IntegrateLayers(object = emb.GFPpooled_v2, method = HarmonyIntegration, orig.reduction = "pca", new.reduction = "integrated.harmony", verbose = FALSE)

emb.GFPpooled_v2 <- FindNeighbors(emb.GFPpooled_v2, reduction = "integrated.cca", dims = 1:5)
emb.GFPpooled_v2 <- FindNeighbors(emb.GFPpooled_v2, reduction = "integrated.harmony", dims = 1:5)
...
emb.GFPpooled_v2 <- RunUMAP(emb.GFPpooled_v2, reduction = "integrated.harmony", dims = 1:5, reduction.name = "umap.harmony")
...
DimPlot(emb.GFPpooled_v2, reduction = "umap.harmony", group.by = c("rep_group", "harmony_clusters"), label.size = 4, pt.size = 1)
dev.off()

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.UMAP.int.harmony.rep.pdf", height = 6, width = 9)
DimPlot(emb.GFPpooled_v2, reduction = "umap.harmony", split.by = "rep_group", label.size = 4, pt.size = 1)
dev.off()
...
emb.GFPpooled_v2@reductions$integrated.harmony
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.harmony.rep.pdf", height = 6, width = 9)
DimPlot(emb.GFPpooled_v2, reduction = "integrated.harmony", split.by = "rep_group")
dev.off()
...
pdf("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.FeaturePlot.INTmarkergenes.umap-harmony.pdf", height = 6, width = 9)
...
```
```{r}
pdf("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.FeaturePlot.alltissuemarkergenes.umap-harmony.pdf", height = 12, width = 12)
...
```
```{r}
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.FeaturePlot.INTmarkergenes.umap-harmony.pdf", height = 6, width = 9)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.DimPlot.umap-harmony.pdf", height = 6, width = 9)
DimPlot(emb.GFPpooled_v2, reduction = "umap.harmony", group.by = "harmony_clusters", label = TRUE, label.size = 6, pt.size = 1)
dev.off()
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.FeaturePlot.alltissuemarkergenes.umap-harmony.pdf", height = 12, width = 12)
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.harmony", features = c("elt-2", "elt-7", "ges-1", "glh-1", "nos-1", "pgl-1", "myo-3", "pat-10", "mls-1", "rab-3", "odr-2",  "mec-7", "myo-2", "tnc-2", "phat-2", "elt-1", "elt-3", "dpy-7"), ncol = 3, coord.fixed = TRUE)
dev.off()
...
# (Loose filtering) contamination clusters we want to remove = 8
emb.GFPpooled_v2.filteredClusters <- subset(emb.GFPpooled_v2, idents = c('9', '18'), invert = TRUE)
...
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("elt-2", "elt-7", "ges-1", "glh-1", "nos-1", "pgl-1", "myo-3", "pat-10", "mls-1", "rab-3", "odr-2",  "mec-7", "myo-2", "tnc-2", "phat-2", "elt-1", "elt-3", "dpy-7"), ncol = 3, coord.fixed = TRUE)
dev.off()
```
...
emb.GFPpooled_v2.filteredClusters.markers <- FindAllMarkers(emb.GFPpooled_v2.filteredClusters, only.pos = F, min.pct = 0.25, logfc.threshold = 1)

write.csv(emb.GFPpooled_v2.filteredClusters.markers,"./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters_markers.csv", row.names = TRUE)

emb.GFPpooled_v2.filteredClusters.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% slice_max(n = 3, order_by = avg_log2FC) 
```
...
num_int_cells <- nrow(Embeddings(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered"))
...
emb.GFPpooled_v2.filteredClusters.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% top_n(n=3, wt=avg_log2FC) -> top3

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.HeatMap-top3.pdf", height = 10, width = 15)
DoHeatmap(emb.GFPpooled_v2.filteredClusters, features = c(top3$gene), raster=F) + 
  theme(axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
dev.off()


emb.GFPpooled_v2.filteredClusters.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% top_n(n=10, wt=avg_log2FC) -> top10

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.HeatMap-top10.pdf", height = 20, width = 15)
DoHeatmap(emb.GFPpooled_v2.filteredClusters, features = c(top10$gene), raster=F) + 
  theme(axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
dev.off()
...
emb.GFPpooled_v2.filteredClusters.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% top_n(n=2, wt=avg_log2FC) -> top2

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.HeatMap-top2.smifish.pdf", height = 10, width = 15)
DoHeatmap(emb.GFPpooled_v2.filteredClusters, features = c(top2$gene, "clec-56", "pbo-4", "C14C6.5", "ugt-14", "endu-2", "cpr-1", "Y32F6A.5"), raster=F) +
  theme(axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
dev.off()


pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.HeatMap-smiFISH.pdf", height = 8, width = 10)
DoHeatmap(emb.GFPpooled_v2.filteredClusters, features = c("clec-56", "pbo-4", "C14C6.5", "ugt-14", "endu-2", "cpr-1", "Y32F6A.5"), raster=F) + 
  theme(axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
dev.off()
```
...
```{r}
# RNAi/FISH targets
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.rnai-FISH.pdf", height = 6, width = 15)  
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("C14C6.5", "cpr-1", "Y32F6A.5", "endu-2", "clec-56", "pbo-4", "ugt-14"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c("C14C6.5", "cpr-1", "Y32F6A.5", "endu-2", "clec-56", "pbo-4", "ugt-14"), raster=F, ncol = 3)

# intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.intestine.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("elt-2", "elt-7", "ges-1"), ncol = 3, coord.fixed = TRUE)
dev.off() 

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("elt-2", "elt-7", "ges-1"))

# germline
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.germ.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("glh-1", "nos-1", "pgl-1"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("glh-1", "nos-1", "pgl-1"))

# muscle
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.muscle.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("myo-3", "pat-10", "lev-11"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("myo-3", "pat-10", "lev-11"))

# neuron
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.neuron.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("rab-3", "odr-2", "mec-7"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("rab-3", "odr-2", "mec-7"))

# pharynx
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.pharynx.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("myo-2", "tnc-2", "phat-2"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("myo-2", "tnc-2", "phat-2"))

# hypodermis
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.hypodermis.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("elt-1", "elt-3", "dpy-7"), ncol = 3, coord.fixed = TRUE)
dev.off()

VlnPlot(object = emb.GFPpooled_v2.filteredClusters, features = c("elt-1", "elt-3", "dpy-7"))

# early intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.earlyint.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("end-1", "acp-2", "ugt-14", "C10C5.4"), ncol = 2 , coord.fixed = TRUE)
dev.off()

# mid intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.midint.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("T19D7.6", "T21E8.4", "C10A4.3", "klo-1"), ncol = 2 , coord.fixed = TRUE) #(not the best) "T20D4.19", "F47B8.4"
dev.off()

# late intestine
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.featureplot.lateint.pdf", height = 6, width = 15)
FeaturePlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", features = c("C14C6.5", "clec-56", "cpr-1", "lec-9"), ncol = 2 , coord.fixed = TRUE)
dev.off()
...
total_cells_expressing_gene <- sum(emb.GFPpooled_v2.filteredClusters@assays$RNA$data["hlh-2", ] > 0) 
print(total_cells_expressing_gene) #716

total_cells_expressing_gene <- sum(emb.GFPpooled_v2.filteredClusters@assays$RNA$data["myo-3", ] > 0) 
print(total_cells_expressing_gene) #85

total_cells_expressing_gene <- sum(emb.GFPpooled_v2.filteredClusters@assays$RNA$data["rab-3", ] > 0) 
print(total_cells_expressing_gene) #149
```
...
```{r}
Cluster0.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==0 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster1.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==1 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster2.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==2 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster3.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==3 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster4.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==4 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster5.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==5 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster6.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==6 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster7.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==7 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster8.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==8 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster9.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==9 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster10.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==10 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster11.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==11 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster12.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==12 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster13.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==13 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster14.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==14 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster15.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==15 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
Cluster16.markers <- emb.GFPpooled_v2.filteredClusters.markers[emb.GFPpooled_v2.filteredClusters.markers$cluster==16 & emb.GFPpooled_v2.filteredClusters.markers$p_val_adj < 0.05, ]
```


```{r}
Cluster0.gene_ids <- bitr(Cluster0.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #3.76% of input gene IDs are fail to map...
Cluster1.gene_ids <- bitr(Cluster1.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #3.31% of input gene IDs are fail to map...
Cluster2.gene_ids <- bitr(Cluster2.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #6.09% of input gene IDs are fail to map...
Cluster3.gene_ids <- bitr(Cluster3.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #2.58% of input gene IDs are fail to map...
Cluster4.gene_ids <- bitr(Cluster4.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #0.96% of input gene IDs are fail to map...
Cluster5.gene_ids <- bitr(Cluster5.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.39% of input gene IDs are fail to map...
Cluster6.gene_ids <- bitr(Cluster6.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.82% of input gene IDs are fail to map...
Cluster7.gene_ids <- bitr(Cluster7.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.04% of input gene IDs are fail to map...
Cluster8.gene_ids <- bitr(Cluster8.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #2.56% of input gene IDs are fail to map...
Cluster9.gene_ids <- bitr(Cluster9.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #2.85% of input gene IDs are fail to map...
Cluster10.gene_ids <- bitr(Cluster10.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.58% of input gene IDs are fail to map...
Cluster11.gene_ids <- bitr(Cluster11.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #2.74% of input gene IDs are fail to map...
Cluster12.gene_ids <- bitr(Cluster12.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.52% of input gene IDs are fail to map...
Cluster13.gene_ids <- bitr(Cluster13.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #5.62% of input gene IDs are fail to map...
Cluster14.gene_ids <- bitr(Cluster14.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #1.7% of input gene IDs are fail to map...
Cluster15.gene_ids <- bitr(Cluster15.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #4.33% of input gene IDs are fail to map...
Cluster16.gene_ids <- bitr(Cluster16.markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Ce.eg.db) #0.96% of input gene IDs are fail to map...
```
...
cluster_gene_list <- split(emb.GFPpooled_v2.filteredClusters.markers$gene, emb.GFPpooled_v2.filteredClusters.markers$cluster)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.dotPlot-GO-BP.pdf", height = 10, width = 20)
...
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.treeMap-GO-BP.pdf", height = 20, width = 30)
...
#early intestine
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('end-1', 'acp-2', 'ugt-14', 'C10C5.4'), raster=F, ncol = 2)
# early_clusters: 6

#mid intestine
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('T19D7.6', 'T21E8.4', 'klo-1', 'C10A4.3'), raster=F, ncol = 2)
# mid_clusters: 5

#late intestine
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('C14C6.5', 'clec-56', 'cpr-1', 'lec-9'), raster=F, ncol = 2)
# late_clusters: 3,4,8,11,12


clusters_to_use <- as.character(c(3:6, 8, 11, 12))
...
bp_dev <- clusterProfiler::simplify(go_compare_bp_dev, cutoff=0.7, by="p.adjust", select_fun=min)

# re-order the clusters to have the "early, mid, to late intestine" display
bp_dev@compareClusterResult$Cluster <- factor(bp_dev@compareClusterResult$Cluster, levels = c("6", "5", "3", "4", "8", "11", "12"))

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.dotPlot-GO-BP_developmental.pdf", height = 10, width = 20)
...
trim_bp_dev <- pairwise_termsim(bp_dev, method = "JC")

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.treeMap-GO-BP_developmental.pdf", height = 10, width = 20)
treeplot(trim_bp_dev, showCategory = 3, cladelab_offset=5, tiplab_offset=.3, fontsize_cladelab =5, fontsize_tiplab =5, hexpand(.2), legend_n = 3,  nCluster = 5)  
dev.off()
```

```{r}
#anterior intestine
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('C14C6.5', 'cpr-1'), raster=F, ncol = 2)
# anterior_clusters: 8, 12, 3

#central intestine
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('endu-2', 'clec-56'), raster=F, ncol = 2)
# central_clusters: 3, 8 

#posterior
VlnPlot(emb.GFPpooled_v2.filteredClusters, features = c('pbo-4'), raster=F, ncol = 2)
# posterior_clusters: 3, 8, 11 

clusters_to_use2 <- as.character(c(3, 8, 11, 12))
...
bp_region <- clusterProfiler::simplify(go_compare_bp_region, cutoff=0.7, by="p.adjust", select_fun=min)

# re-order the clusters to have the "early, mid, to late intestine" display
bp_region@compareClusterResult$Cluster <- factor(bp_region@compareClusterResult$Cluster, levels = c("12", "3", "8", "11"))

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.dotPlot-GO-BP_region.pdf", height = 10, width = 20)
...
trim_bp_region <- pairwise_termsim(bp_region, method = "JC")

pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClusters.treeMap-GO-BP_region.pdf", height = 10, width = 20)
treeplot(trim_bp_region, showCategory = 3, cladelab_offset=5, tiplab_offset=.3, fontsize_cladelab =5, fontsize_tiplab =5, hexpand(.2), legend_n = 3,  nCluster = 5)  
dev.off()
```
...
dim(emb.GFPpooled_v2) #15289  2579
dim(emb.GFPpooled_v2.filteredClusters) #15289   973
dim(emb.GFPpooled_v2.finalfiltClusters) #15289   945 

dim(emb.ALLpooled_v2) #18794 18748
```
...
head(emb.GFPpooled_v2@reductions$harmony@cell.embeddings)
view(emb.GFPpooled_v2@reductions$harmony@cell.embeddings)
...
metadata_har <- as.data.frame(emb.GFPpooled_v2@reductions$harmony@cell.embeddings)
...
metadata_pca_long <- metadata_pca %>%
  pivot_longer(
    cols = starts_with("PC_"),  # or use harmony_1:harmony_3 to be specific
    names_to = "PCA_PC",
    values_to = "Embedding_Value"
  )
