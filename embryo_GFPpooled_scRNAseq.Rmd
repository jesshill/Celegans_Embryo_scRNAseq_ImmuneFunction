...
gene_express_per_cell2 <- rowSums(exp_matrix2)
genes_express_only_once2 <- sum(gene_express_per_cell2==1)

exp_matrix3 <- as.matrix(emb.ALLpooled_v2@assays$RNA$counts.Rep_3)
gene_express_per_cell3 <- rowSums(exp_matrix3)
genes_express_only_once3 <- sum(gene_express_per_cell3==1)

exp_matrix4 <- as.matrix(emb.ALLpooled_v2@assays$RNA$counts.Rep_4)
gene_express_per_cell4 <- rowSums(exp_matrix4)
genes_express_only_once4 <- sum(gene_express_per_cell4==1)
```
