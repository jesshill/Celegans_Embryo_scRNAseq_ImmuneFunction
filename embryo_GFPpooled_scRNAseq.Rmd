...
ggsave("./DESeq_output2/GFP_pooled/emb.GFPpooled.VlnPlot.png")
```
...
******* need to find out how many cells per group and plot for erin
```{r}
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.Murray-Anterior.png") 
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.Murray-Mid.png")
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.Murray-Posterior.png")
```
