...
emb.GFPpooled_v2 <- FindNeighbors(emb.GFPpooled_v2, dims = 1:20, reduction = "pca")
...
DimPlot(emb.GFPpooled_v2, reduction = "umap.harmony", group.by = "harmony_clusters", label = TRUE, label.size = 4, pt.size = 1)
dev.off()

DimPlot(emb.GFPpooled_v2, reduction = "umap.cca", group.by = "cca_clusters", label = TRUE, label.box = TRUE, label.size = 4, pt.size = 1)

DimPlot(emb.GFPpooled_v2, reduction = "umap.unintegrated", group.by = "unintegrated_clusters", label = TRUE, label.box = TRUE, label.size = 4, pt.size = 1)
```
