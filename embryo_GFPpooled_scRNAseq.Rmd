...
```{r}
emb.GFPpooled.data1 <- Read10X_h5("./10x_cloud_analysis/GFP_pooled_count/raw_feature_bc_matrix.h5") # Robs

emb.GFPpooled.data <- Read10X_h5("./cellranger/all_GFP/outs/count/filtered_feature_bc_matrix.h5")

#emb.GFP1.data <- Read10X_h5("./cellranger/GFP_1/filtered_feature_bc_matrix.h5")
```
...
```{r}
emb.GFPpooled <- FindNeighbors(emb.GFPpooled, dims = 1:6)
...
```{r}
emb.GFPpooled <- RunUMAP(emb.GFPpooled, dims = 1:6)
```
...
for justin
```{r}
emb.GFPpooled.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% top_n(n=3, wt=avg_log2FC) -> top3

DoHeatmap(emb.GFPpooled, features = top3$gene,raster=F)
ggsave("./DESeq2_output2/GFP_pooled/emb.GFPpooled.HeatMap-top3.png")
...
```{r}
# intestine_anterior
FeaturePlot(emb.GFPpooled, features = c('ZC204.12', 'cpr-1', 'ceh-37'), raster=F, , ncol = 3)
ggsave("./DESeq2_output2/GFP_pooled/emb.GFPpooled.Murray-Anterior.png") 

# intestine_middle_and_posterior
FeaturePlot(emb.GFPpooled, features = c('irg-7', 'pal-1', 'cpr-1', 'ceh-37'), raster=F, , ncol = 4)
ggsave("./DESeq2_output2/GFP_pooled/emb.GFPpooled.Murray-Mid.png")

# intestine_far_posterior
FeaturePlot(emb.GFPpooled, features = c('faah-1', 'pbo-4', 'psa-3'), raster=F, ncol = 3)
...
ggsave("./DESeq2_output2/GFP_pooled/emb.GFPpooled.HeatMap-top10clecs.png")
```
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.DimPlot.png")

ElbowPlot(emb.GFPpooled.specificClusters)
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.ElbowPlot.png")
```
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.Clustree.png")
...
write.csv(emb.GFPpooled.specificClusters.recluster.markers,"./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.markers.csv", row.names = TRUE)
```
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.GO.png")
```
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.HeatMap-top2.png")
```
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.FeaturePlot-PosCtrls.png")


VlnPlot(emb.GFPpooled.specificClusters.recluster, features = c("elt-2","elt-7", 'ges-1'))
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.VlnPlot-PosCtrls.png")
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.FeaturePlot.png")
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.Murray-Anterior.png") 

# intestine_middle_and_posterior
FeaturePlot(emb.GFPpooled.specificClusters.recluster, features = c('irg-7', 'pal-1', 'cpr-1', 'ceh-37'), raster=F, , ncol = 4)
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.Murray-Mid.png")
...
ggsave("./Output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.Murray-Posterior.png")
