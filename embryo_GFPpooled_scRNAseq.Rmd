...
emb.GFPpooled_v2 <- FindNeighbors(emb.GFPpooled_v2, reduction = "integrated.harmony", dims = 1:20)
...
emb.GFPpooled_v2 <- RunUMAP(emb.GFPpooled_v2, reduction = "integrated.cca", dims = 1:20, reduction.name = "umap.cca")
emb.GFPpooled_v2 <- RunUMAP(emb.GFPpooled_v2, reduction = "integrated.harmony", dims = 1:20, reduction.name = "umap.harmony")
...
emb.GFPpooled_v2.filteredClusters <- subset(emb.GFPpooled_v2, idents = c('8'), invert = TRUE)
```
...
emb.GFPpooled_v2.filteredClusters <- FindNeighbors(emb.GFPpooled_v2.filteredClusters, dims = 1:5)
...
DimPlot(emb.GFPpooled_v2.filteredClusters, reduction = "umap.filtered", label = TRUE)
```
