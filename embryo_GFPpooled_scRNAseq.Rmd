...
emb.GFPpooled.markers <- emb.GFPpooled.markers %>% rename(WBGeneID = genes.df$wbps_gene_id)
```
...
my_ontology_plot(my_tea_analysis(emb.GFPpooled.markers %>% filter(p_val_adj < 0.05, avg_log2FC > 1.5), tissue_df), "Tissue Ontology")
