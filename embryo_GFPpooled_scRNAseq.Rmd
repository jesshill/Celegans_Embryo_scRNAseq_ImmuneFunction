...
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.DimPlot.png")
...
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.HeatMap1.png")
...
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.HeatMap1-6.png")
...
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.JackStrawPlot.png")
...
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.ElbowPlot.png")
...
```{r}
# emb.ALLpooled_v2_20 <- FindNeighbors(emb.ALLpooled_v2, dims = 1:20)
# emb.ALLpooled_v2_10 <- FindNeighbors(emb.ALLpooled_v2, dims = 1:10)
emb.ALLpooled_v2 <- FindNeighbors(emb.ALLpooled_v2, dims = 1:20)

# emb.GFPpooled_v2_20 <- FindNeighbors(emb.GFPpooled_v2, dims = 1:20)
# emb.GFPpooled_v2_10 <- FindNeighbors(emb.GFPpooled_v2, dims = 1:10)
...
# emb.ALLpooled_v2.clust10 <- FindClusters(
#   object = emb.ALLpooled_v2_10,
#   reduction.type = "pca",
#   resolution = c(0.2, 0.4, 0.8, 1, 1.2),
#   dims.use = 1:10,
#   save.SNN = TRUE)
# 
# emb.ALLpooled_v2.clust20 <- FindClusters(
#   object = emb.ALLpooled_v2_20,
#   reduction.type = "pca",
#   resolution = c(0.2, 0.4, 0.8, 1, 1.2),
#   dims.use = 1:20,
#   save.SNN = TRUE)
...
# emb.GFPpooled_v2.clust10 <- FindClusters(
#   object = emb.GFPpooled_v2_10,
#   reduction.type = "pca",
#   resolution = c(0.2, 0.4, 0.8, 1, 1.2),
#   dims.use = 1:10,
#   save.SNN = TRUE)
# 
# emb.GFPpooled_v2.clust20 <- FindClusters(
#   object = emb.GFPpooled_v2_20,
#   reduction.type = "pca",
#   resolution = c(0.2, 0.4, 0.8, 1, 1.2),
#   dims.use = 1:20,
#   save.SNN = TRUE)
...
# clustree(emb.ALLpooled_v2.clust10, prefix = "RNA_snn_res.")
# clustree(emb.ALLpooled_v2.clust20, prefix = "RNA_snn_res.")
clustree(emb.ALLpooled_v2.clust, prefix = "RNA_snn_res.")

#clustree(emb.GFPpooled_v2.clust10, prefix = "RNA_snn_res.")
#clustree(emb.GFPpooled_v2.clust20, prefix = "RNA_snn_res.")
...
clustree(emb.ALLpooled_v2.clust, prefix = "RNA_snn_res.")
#ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.Clustree.png")
...
ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.unint.png")
...
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.UMAP.unint2.png")
...
ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.unint2.png")

DimPlot(emb.ALLpooled_v2, reduction = "umap.unintegrated", split.by = "rep_group")
ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.unint.rep.png")
```
...
ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.int.harmony.png")

DimPlot(emb.ALLpooled_v2, reduction = "umap.harmony", split.by = "rep_group")
ggsave("./Seurat_output/all_pooled_v2/emb.ALLpooled_v2.UMAP.int.harmony.rep.png")
```
```{r}
