...
contamination clusters = 12 8 4 11

```{r}
emb.GFPpooled.specificClusters <- RunUMAP(subset(emb.GFPpooled, idents = c('12','8','4','11'), invert = TRUE), dims = 1:6)
...
emb.GFPpooled.specificClusters <- FindNeighbors(emb.GFPpooled.specificClusters, dims = 1:5)
...
emb.GFPpooled.specificClusters.recluster <- RunUMAP(emb.GFPpooled.specificClusters.recluster, dims = 1:5)
