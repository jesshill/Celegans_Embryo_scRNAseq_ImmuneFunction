...
```{r}
emb <- FindNeighbors(emb, dims = 1:7)
...
write.csv(emb1.markers,"/Users/jessicahill/Documents/GitHub/Celegans_Embryo_scRNAseq_ImmuneFunction/Output/GFP1/emb_GFP1_markers.csv", row.names = TRUE)
```
