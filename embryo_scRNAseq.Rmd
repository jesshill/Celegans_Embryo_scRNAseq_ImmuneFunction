...
```{r}
emb.all.data <- Read10X_h5("./10x_cloud_analysis/all_pooled_count/raw_feature_bc_matrix.h5")
...
emb.GFP1.data <- Read10X_h5("./10x_cloud_analysis/unsort_2_count/raw_feature_bc_matrix.h5")

emb.GFP2.data <- Read10X_h5("./10x_cloud_analysis/unsort_2_count/raw_feature_bc_matrix.h5")
```
...
emb1 <- FindClusters(emb, resolution = 1.2) #1.2 didn't look clustered
...
```{r}
emb2 <- RunUMAP(emb2, dims = 1:5)
```

```{r}
# Note that you can set `label = TRUE` or use the LabelClusters function to help label individual clusters
DimPlot(emb2, reduction = "umap", label = "TRUE", label.box = TRUE)
```
