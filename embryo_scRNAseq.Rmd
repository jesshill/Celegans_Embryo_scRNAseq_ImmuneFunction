...
```{r}
emb <- FindNeighbors(emb, dims = 1:8)
...
write.csv(emb1.markers,"/Users/jessicahill/Documents/GitHub/Celegans_Embryo_scRNAseq_ImmuneFunction/Output/GFP2/emb_GFP2_markers.csv", row.names = TRUE)
```
