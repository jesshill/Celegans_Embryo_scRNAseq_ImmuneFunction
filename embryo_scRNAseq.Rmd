...
genes.df <- getBM(mart = mart, 
      ...
      value = list("caelegprjna13758", rownames(emb.GFP1.data)),
...
c(nrow(genes.df), nrow(emb.GFP1.data))

# are there are genes missing?
nrow(emb.GFP1.data)-nrow(genes.df)
```
...
```{r}
emb <- CreateSeuratObject(counts = emb.GFP1.data.filt, project = "emb_GFP1", min.cells = 3, min.features = 200)
```
