...
```{r}
emb <- FindNeighbors(emb, dims = 1:6)
...
write.csv(emb1.markers,"/Users/jessicahill/Documents/GitHub/Celegans_Embryo_scRNAseq_ImmuneFunction/Output/unsort1/emb_unsort1_markers.csv", row.names = TRUE)
```
