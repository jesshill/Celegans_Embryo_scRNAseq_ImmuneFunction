...
DimPlot(emb.unsort1, reduction = "umap", label = "FALSE", label.box = TRUE)
ggsave("./Output/unsort1/emb.unsort1.umap.png")
```

```{r}
DimPlot(emb.unsort2, reduction = "umap", label = "FALSE", label.box = TRUE)
ggsave("./Output/unsort2/emb.unsort2.umap.png")
```

```{r}
DimPlot(emb.GFP1, reduction = "umap", label = "FALSE", label.box = TRUE)
ggsave("./Output/GFP1/emb.GFP1.umap.png")
```

```{r}
DimPlot(emb.GFP2, reduction = "umap", label = "FALSE", label.box = TRUE)
